...
#
#   Modified for e-paper 2.7 inch color V2 by J.C. Kleijn Aug 2021
# *
import sys
...
owm = pyowm.OWM('44a4ae20130635382168a71fdb15f240')
...
def main():
    ...
    while True:
        ...
        try:
            ...
            HBlackimage = Image.new('1', (epd2in7b_V2.EPD_HEIGHT, epd2in7b_V2.EPD_WIDTH), 255)  # 298*126
            HRedimage = Image.new('1', (epd2in7b_V2.EPD_HEIGHT, epd2in7b_V2.EPD_WIDTH), 255)  # 298*126    
